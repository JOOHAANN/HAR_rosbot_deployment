...
_C.TEST = CN()
_C.TEST.CHECKPOINT = ""
_C.TEST.OUTPUT_DIR = "./outputs/test"
_C.TEST.SPLIT = "test"
...
# for preprocessed tensor datasets: "val" during training eval, "test" for final testing
_C.DATASETS.TEST.SPLIT_NAME = 'val'
...
_C.TRANSFORM.TRAIN.TENSOR_AUGMENTATION = False
_C.TRANSFORM.TRAIN.TENSOR_CROP_SCALE = (0.75, 1.0)
_C.TRANSFORM.TRAIN.TENSOR_CROP_RATIO = (0.9, 1.1)
_C.TRANSFORM.TRAIN.TENSOR_ERASING_PROB = 0.25
_C.TRANSFORM.TRAIN.TENSOR_NOISE_STD = 0.0
_C.TRANSFORM.TRAIN.TENSOR_RESIZE_SIZE = 0
...
_C.TRANSFORM.TEST.TENSOR_RESIZE_SIZE = 0
...
_C.MODEL.CRITERION.LABEL_SMOOTHING = 0.0
