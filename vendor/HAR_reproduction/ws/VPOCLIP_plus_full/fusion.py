...
class ADLFeatureReducer(nn.Module):
    ...
    def forward(self, x):
        ...
        # Reshape to [batch, channel, time] as required by Conv1d
...
class PoseADLFeatureExtractor(nn.Module):
    ...
    def forward(self, x):
        ...
        # Apply attention over the person axis
        ...
        # 64-dim feature per time/joint -> 36
        # [B,T,V,C] -> [B,T,V,36]
        x = self.to_grid(x)
...
class TriModalFusion(nn.Module):
    ...
    def __init__(
        ...
        # Linear layers to align channel counts
